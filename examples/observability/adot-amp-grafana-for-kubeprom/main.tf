...
module "eks_blueprints_kubernetes_addons" {
  ...
  amazon_prometheus_workspace_endpoint = aws_prometheus_workspace.demo.prometheus_endpoint
...
resource "aws_prometheus_rule_group_namespace" "node-rules" {
  name         = "noderules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
...
resource "aws_prometheus_rule_group_namespace" "node-nw" {
  name         = "nodenw-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
...
resource "aws_prometheus_rule_group_namespace" "node-exporter-rules" {
  name         = "ne-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
...
resource "aws_prometheus_rule_group_namespace" "node-exporter" {
...
resource "aws_prometheus_rule_group_namespace" "kubesys-schdlr" {
...
resource "aws_prometheus_rule_group_namespace" "kubesys-kblt" {
...
resource "aws_prometheus_rule_group_namespace" "kubesys-kbpxy" {
...
resource "aws_prometheus_rule_group_namespace" "kubesys-cm" {
...
resource "aws_prometheus_rule_group_namespace" "kubesys-apiserver" {
...
resource "aws_prometheus_rule_group_namespace" "kube-storage" {
...
resource "aws_prometheus_rule_group_namespace" "kube-resources" {
...
resource "aws_prometheus_rule_group_namespace" "kube-apps" {
  name         = "kubeapps-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
...
resource "aws_prometheus_rule_group_namespace" "kubeprom-noderecording" {
...
resource "aws_prometheus_rule_group_namespace" "kube-prom" {
  name         = "kubeprom-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
...
resource "aws_prometheus_rule_group_namespace" "api-slos" {
  name         = "apislos-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
...
resource "aws_prometheus_rule_group_namespace" "api-histogram" {
  name         = "apihistogram-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
  - name: apihg-01
...
resource "aws_prometheus_rule_group_namespace" "api-burnrate" {
  name         = "apiburnrate-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
  - name: apibr-01
...
resource "aws_prometheus_rule_group_namespace" "general" {
  name         = "generic-rules"
  workspace_id = aws_prometheus_workspace.demo.id
  data         = <<EOT
groups:
    ...
    rules:
      - alert: InfoInhibitor
        ...
        labels:
           severity: none
        annotations:
          description: This is an alert that is used to inhibit info alerts. By themselves, the info-level alerts are sometimes very noisy, but they are relevant when combined with other alerts. This alert fires whenever theres a severity="info" alert, and stops firing when another alert with a severity of 'warning' or 'critical' starts firing on the same namespace. This alert should be routed to a null receiver and configured to inhibit alerts with severity="info".
EOT
}
...
resource "aws_prometheus_rule_group_namespace" "api-server" {
...
resource "aws_prometheus_rule_group_namespace" "kube-prometheus-stack" {
